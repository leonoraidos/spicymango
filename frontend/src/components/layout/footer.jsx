...
const Footer = () => {
  return (
    <footer className="bg-red-500 fixed bottom-0 w-screen z-50 h-12">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center self-center align-middle">
